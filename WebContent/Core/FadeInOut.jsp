...
<script>
	$(function(){
		...
		//2]fadeToggle()함수 사용-fadeIn()과 fadeOut()을 동시 구현
		/*
		$('.title').click(function(){
		...
		/*3]fadeToggle()함수 미 사용-adeIn()과 fadeOut()함수를 
		이용해
   	 	열려진 제목 클릭시 다른 제목의
		...
		$('.title').click(function(){
			...
			if($(this).next().css('display')=='none'){
				$('.content').fadeOut(2000);//열린 모든 내용 숨기기
				$(this).next().fadeIn(2000);//해당 제목의 내용 보이기
			}
...
<body>
	<fieldset>
		<legend>fadeIn(),fadeOut()함수,fadeToggle()함수</legend>
