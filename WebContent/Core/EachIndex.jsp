...
<script>
	$(function(){
		...
		var clickDiv = $('div').click(function(){
			//부모 자식 구조로 인덱스가 부여됨:0번은 legend,DIV1이 1번
		...
		console.log('css()함수:',$('#DIV1').css('backgroundColor'));//rgb(0,255,0)
		console.log('prop()함수:',$('#DIV1').prop('style'));//[o]
		console.log('attr()함수:',$('#DIV1').attr('style'));//[o]
