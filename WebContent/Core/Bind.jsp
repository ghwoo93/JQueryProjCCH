...
<script>
	$(function(){
		...
		console.log('마지막 자식인 div의 갯수 : ',$('div:last-child').length);//2
		//선택된 2 개의 DIV중 첫번째 DIV만 적용됨-선택된 모든 객체에 적용시 each()함수 적용
		console.log('div:last-child에 html()함수 적용 : ',$('div:last-child').html());
		console.log('[선택된 마지막 자식인 모든 DIV태그들의 시작태그와 종료태그 사이의 값 출력하기]')
		...
		//<div id="naver" title="네이버">네이버</div> 인덱스가 2
		console.log($('div:eq(2)').html());//네이버
		console.log($('div:eq(5)').html());
